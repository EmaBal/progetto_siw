	...
	<f:view>
		<div class="container">
			...
			Insert address fields:<br><br>
				<div>
					Street:<br>
					<h:inputText value="#{userController.providerController.addressController.street}"
				...
				<div>
					City:<br>
					<h:inputText value="#{userController.providerController.addressController.city}"
				...
				<div>
					State:<br>
					<h:inputText value="#{userController.providerController.addressController.state}"
				...
				<div>
					Zip code:<br>
					<h:inputText value="#{userController.providerController.addressController.zipcode}"
				...
				<div>
					Country:<br>
					<h:inputText value="#{userController.providerController.addressController.country}"
				...
				<div>
					<c:choose>
						<c:when test="${userController.providerController.provider.address==null}">
