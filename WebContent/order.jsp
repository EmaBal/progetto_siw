			...
			<div class="col-sm-6" align="center">
				<c:choose>
					<c:when
						...
						<c:choose>
							<c:when
								test="${userController.userprivilege.equals('it.uniroma3.model.Customer') and (userController.orderController.order.confirmationDate != null)}">
								<h3>Your order:</h3>
							</c:when>
							<c:when
								test="${userController.userprivilege.equals('it.uniroma3.model.Customer') and (userController.orderController.order.confirmationDate == null)}">
						...
						</c:choose>(created the ${userController.orderController.order.creationDate}
						<c:if
