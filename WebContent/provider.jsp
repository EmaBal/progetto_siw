	...
	<f:view>
		...
		<div class="first">
			...
			<div class="col-sm-6 container" align="center">
				<div>
					<b>Company Name:</b>
					${userController.providerController.provider.name}
				</div>
				<h1>Details</h1>
				<div>
					<b>Phone number:</b>
					${userController.providerController.provider.phonenumber}
				</div>
				<div>
					<b>Email:</b> ${userController.providerController.provider.email}
				</div>
				<div>
					<b>VAT code:</b>
					${userController.providerController.provider.vatin}
				</div>
				<h:form>
					<c:choose>
						<c:when
						...
						<c:otherwise>
							...
							<div>
								<b>Street :</b>
								${userController.providerController.provider.address.street}
							</div>
							<div>
								<b>City:</b>
								${userController.providerController.provider.address.city}
							</div>
							<div>
								<b>State:</b>
								${userController.providerController.provider.address.state}
							</div>
							<div>
								<b>Zip code:</b>
								${userController.providerController.provider.address.zipcode}
							</div>
							<div>
								<b>Country :</b>
								${userController.providerController.provider.address.country}
							</div>
						</c:otherwise>
					</c:choose>
					<h2>Products :</h2>
